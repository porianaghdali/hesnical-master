...
export default function HeaderTheme({ currentPreferredTheme }) {
  const dict = useDictionary();
  const [preferredTheme, setPreferredTheme] = useState(currentPreferredTheme);
  const router = useRouter();

  const changePreferredTheme = useCallback((t) => {
    setPreferredTheme(t);
